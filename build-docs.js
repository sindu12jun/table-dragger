...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _index2.default)(document.querySelector('#default-table'), { animation: 300, mode: 'free' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _drag = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _draggableList = __webpack_require__(393);
	...
	var Drag = function () {
	  function Drag() {
	    ...
	    var defaultHandlers = options.mode === 'column' ? table.rows[0].children : (0, _from2.default)(table.rows).map(function (row) {
	      return row.children[0];
	    });
	
	    this.handlers = (0, _from2.default)(options.dragHandle ? table.querySelectorAll(options.dragHandle) : defaultHandlers);
	    if (!this.handlers) {
	    ...
	    table.classList.add(_util.classes.originTable);
	    this.el = table;
	    this.bindEvents();
	  }
	  ...
	  (0, _createClass3.default)(Drag, [{
	    ...
	    value: function bindEvents() {
	      ...
	      try {
	        for (var _iterator = (0, _getIterator3.default)(this.handlers), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          (0, _util.on)(h, 'mousedown', this.onTap);
	          (0, _util.on)(h, 'touchstart', this.onTap);
	          (0, _util.on)(h, 'pointerdown', this.onTap);
	        }
	      } catch (err) {
	    ...
	    value: function onTap(event) {
	      ...
	      (0, _util.on)(document, 'mousemove', this.startBecauseMouseMoved);
	      (0, _util.on)(document, 'mouseup', function () {
	        (0, _util.remove)(document, 'mousemove', _this.startBecauseMouseMoved);
	      });
	    }
	  }, {
	    key: 'destroy',
	    value: function destroy() {
	      ...
	      try {
	        for (var _iterator2 = (0, _getIterator3.default)(this.handlers), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          ...
	          (0, _util.remove)(h, 'mousedown', this.removeTap);
	          (0, _util.remove)(h, 'touchstart', this.removeTap);
	          (0, _util.remove)(h, 'pointerdown', this.removeTap);
	        }
	      } catch (err) {
	    ...
	    value: function startBecauseMouseMoved(event) {
	      var gapX = Math.abs(event.clientX - this.tappedCoord.x);
	      var gapY = Math.abs(event.clientY - this.tappedCoord.y);
	      ...
	      (0, _util.remove)(document, 'mousemove', this.startBecauseMouseMoved);
	
	      this.sortTable = new _draggableList2.default({
	        mode: mode,
	        originTable: this
	      });
	
	      (0, _util.on)(document, 'mouseup', this.sortTable.destroy);
	    }
	  }], [{
	    key: 'create',
	...
	function checkIsTable(ele) {
	  return (typeof ele === 'undefined' ? 'undefined' : (0, _typeof3.default)(ele)) === 'object' && 'nodeType' in ele && ele.nodeType === 1 && ele.cloneNode && ele.nodeName === 'TABLE';
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(355).f('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(314)
	  ...
	  , enumKeys       = __webpack_require__(362)
	...
	if(!USE_NATIVE){
	  ...
	  __webpack_require__(364).f  = $propertyIsEnumerable;
	  __webpack_require__(363).f = $getOwnPropertySymbols;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// all enumerable object keys, includes symbols
	var getKeys = __webpack_require__(334)
	  , gOPS    = __webpack_require__(363)
	  , pIE     = __webpack_require__(364);
	module.exports = function(it){
	  var result     = getKeys(it)
	    , getSymbols = gOPS.f;
	  if(getSymbols){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pIE            = __webpack_require__(364)
	  , createDesc     = __webpack_require__(327)
	  , toIObject      = __webpack_require__(336)
	  , toPrimitive    = __webpack_require__(326)
	  , has            = __webpack_require__(329)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(360)('asyncIterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(315).Array.from;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(315).Object.assign;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragula = __webpack_require__(394);
	...
	var Dragger = function () {
	  function Dragger(_ref) {
	    ...
	    var fakeTables = buildTables(originTable.el, mode);
	    sizeFakeTables(fakeTables, originTable.el, mode);
	    this.mode = mode;
	
	    this.destroy = this.destroy.bind(this);
	
	    var options = originTable.options;
	    var dragger = originTable.dragger;
	    var index = mode === 'column' ? originTable.activeCoord.x : originTable.activeCoord.y;
	
	    var s = originTable.el.getAttribute('cellspacing');
	    s = s === null ? 2 : s;
	    var a = mode === 'column' ? 'margin-right' : 'margin-bottom';
	    this.el = fakeTables.reduce(function (previous, current, indexOrder) {
	      ...
	      if (options.onlyBody && mode === 'row' && !(0, _from2.default)(current.children).some(function (o) {
	    ...
	    this.el.classList.add(_util.classes.draggableTable);
	    this.el.classList.add('sindu_' + mode);
	    (0, _util.css)(this.el, { position: 'fixed' });
	    (0, _util.insertBeforeSibling)({ target: this.el, origin: originTable.el });
	
	    this.originTable = originTable;
	
	    this.el.parentElement.classList.add(_util.classes.dragging);
	
	    var bodyPaddingRight = parseInt(document.body.style.paddingRight, 0) || 0;
	    var bodyOverflow = document.body.style.overflow;
	    this.drake = (0, _dragula2.default)([this.el], {
	      animation: 300,
	      mirrorContainer: this.el,
	      staticClass: _util.classes.static,
	      ...
	      (0, _util.remove)(document, 'mouseup', _this.destroy);
	      dragger.emit('onDrag');
	    }).on('dragend', function (el) {
	      (0, _util.css)(document.body, { overflow: bodyOverflow, 'padding-right': bodyPaddingRight + 'px' });
	      var from = index;
	      var to = (0, _from2.default)(_this.el.children).indexOf(el);
	      sortTable(_this.mode, from, to, _this.originTable.el);
	      _this.destroy();
	  ...
	  (0, _createClass3.default)(Dragger, [{
	    ...
	    value: function destroy() {
	      ...
	      this.el.parentElement.classList.remove(_util.classes.dragging);
	      if (!isTest) {
	    ...
	    value: function _renderPosition() {
	      var originRect = this.originTable.el.getBoundingClientRect();
	
	      (0, _util.css)(this.el, { top: originRect.top + 'px', left: originRect.left + 'px' });
	      if (isTest) {
	        (0, _util.css)(this.el, { left: '500px' });
	      }
	    }
	  }, {
	    key: '_renderTables',
	    value: function _renderTables() {
	      var oel = this.originTable.el;
	      var rect = oel.getBoundingClientRect();
	
	      (0, _util.css)(this.el, { width: rect.width + 'px', height: rect.height + 'px' });
	...
	function getColumnAsTableByIndex(table, index) {
	  ...
	  (0, _util.css)(cTable, { 'table-layout': 'fixed', width: 'initial', height: 'initial' });
	  ...
	  cTable.removeAttribute('id');
	  cTable.classList.remove(_util.classes.originTable);
	...
	function sizeColumnFake(fakeTables, table) {
	  (0, _from2.default)((0, _util.getLongestRow)(table).children).forEach(function (cell, index) {
	  ...
	  var rowHeights = (0, _from2.default)(table.rows).map(function (row) {
	...
	function sizeRowFake(fakeTables, table) {
	  var cells = (0, _util.getLongestRow)(table).children;
	...
	function sortTable(mode, from, to, table) {
	  (mode === 'column' ? sortColumn : sortRow)({ from: from, to: to, table: table });
	}
	
	function buildRowTables(table) {
	  return (0, _from2.default)(table.rows).map(function (row) {
	    var cTable = table.cloneNode(true);
	    (0, _util.css)(cTable, 'table-layout', 'fixed');
	    var cols = cTable.querySelectorAll('col');
	    (0, _util.css)(cTable, { 'table-layout': 'fixed', width: 'initial', height: 'initial' });
	    cTable.removeAttribute('width');
	    cTable.removeAttribute('height');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var crossvent = __webpack_require__(400);
	var classes = __webpack_require__(403);
	var doc = document;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var atoa = __webpack_require__(396);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ticky = __webpack_require__(398);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var customEvent = __webpack_require__(401);
	var eventmap = __webpack_require__(402);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getScrollBarWidth = exports.sort = exports.insertBeforeSibling = exports.appendSibling = exports.remove = exports.on = exports.empty = exports.css = exports.getLongestRow = exports.classes = undefined;
	
	var _keys = __webpack_require__(405);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(315).Object.keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(408)('keys', function(){
	  return function keys(it){
	    return $keys(toObject(it));
	  };
	});
